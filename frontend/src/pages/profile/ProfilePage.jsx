...
const ProfilePage = () => {
 ...
 const {data: authUser}= useQuery({ queryKey: ["authUser"] });
  ...
  const {
    ...
    queryFn: async () => {
      try {
        ...
        if (!res.ok)
          throw new Error(data.error || "Error while fetching userData");
        console.log(data);
        return data;
      } catch (error) {
        throw error;
  ...
  const {updateProfileMutate, isUpdatingProfile}=useUpdateProfile()
  ...
  const memberSince = formatMemberSinceDate(userData?.createdAt);
    ...
    <>
      <div className="flex-[4_4_0]  border-r border-gray-700 min-h-screen ">
        ...
        <div className="flex flex-col">
                ...
                {!isMyProfile && (
                  <button
                    ...
                    onClick={() => {
                      ...
                      follow(userData._id)
                      !amIfollowing && toast.success("Followed successfully")
                      amIfollowing && toast.success("Unfollowed Succesfully")
                    }
                  ...
                  {userData?.link && (
                    <div className="flex gap-1 items-center ">
                      <>
                        ...
                        <a
                          href="mailto:rohanpachauri01@gmail.com"
                          target="_blank"
                          rel="noreferrer"
                          className="text-sm text-blue-500 hover:underline"
                        >
                          rohanpachauri01@gmail.com
                        </a>
                      </>
                    </div>
                  )}
          ...
          <Posts feedType={feedType} userId={userData?._id} username={username}/>
        </div>
      </div>
    </>
  );
